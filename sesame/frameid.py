...
from dynet import Model, LSTMBuilder, SimpleSGDTrainer, AdamTrainer, lookup, concatenate, rectify, renew_cg, dropout, log_softmax, esum, pick
...
model = Model()
trainer = SimpleSGDTrainer(model) #changed from (model) to (model, 0.001)
